...
async function embedDocuments(documents) {
    documents.forEach(async (document, index) => {        
        ...
        const insertStmt = `INSERT INTO vec_items (document, embedding) 
                                        VALUES ('${document}', float_array_384(${vector}))`
...
/*
   ...
   -- Change current session 
    ALTER SESSION SET current_schema = <youruser>;

    -- Define a VARRAY type
    -- DROP TYPE float_array_384
    CREATE OR REPLACE TYPE float_array_384 AS VARRAY(384) OF BINARY_FLOAT;
    ...
    INSERT INTO vec_items (document, embedding) 
                VALUES ('testing', float_array_384(1.1, 1.2, 1.3, 1.4));
